...
<c:set var="member" value="${rq.loginedMember}"/>
	<section class="container mx-auto mt-5 px-3">
		<form action="/usr/member/doModifyProfile">
			...
			<div class="w-2/4 mx-auto bg-gray-200 text-gray-600 flex flex-col text-center py-5">
	  			<label class="mb-2">이메일 : <input type="text" value="${member.email}" name="email"/></label>
	  			<label class="mb-2">닉네임 : <input type="text" value="${member.nickname}" name="nickname"/></label>
	  			<label>전화번호 : <input type="text" value="${member.cellphoneNo}" name="cellphoneNo"/></label>
			</div> 
		</form>
	</section>
